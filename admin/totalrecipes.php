...
if(isset($_SESSION['adminonline']) && !empty($_SESSION['adminonline'])) {
    ...
    $fetches = $product->get_allusers_recipe();
              ...
              <tr>
                    ...
                    <td class="py-0 px-1">
                        <div class="fs-6 lh-1">
                            ...
                            <p class="fw-lighter truncate-1 m-0"><?php echo substr($f['recipe_desc'],1,100); echo ".." ?></p>
                        </div>
                    </td>
                    <td class="py-0 px-1 text-center">
                   <span class="py-1 px-3 "><?php echo substr( $f['recipe_instruction'],1,  100); echo ".." ?></span> </td>
                    ...
                    <div class="btn-group" role="group">
                           ...
                           <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                               ...
                               <li><a class="dropdown-item" href="viewrecipe.php?id= <?php echo $f['recipe_id'] ?>">View Details</a></li>
                               
                               <li><a class="dropdown-item"  href="process/approverecipe.php?id=<?php echo $f['recipe_id'] ?>">Publish</a></li>
                               
                               <li><a class="dropdown-item delete_data"  href="process/disapproverecipe.php?id=<?php echo $f['recipe_id'] ?>">Don't Publish</a></li>
                          </ul>
